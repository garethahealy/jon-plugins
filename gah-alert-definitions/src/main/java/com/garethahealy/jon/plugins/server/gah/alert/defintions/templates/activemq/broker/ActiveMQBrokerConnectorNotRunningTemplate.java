...
public class ActiveMQBrokerConnectorNotRunningTemplate extends NotRunningTemplate {

    public ActiveMQBrokerConnectorNotRunningTemplate() {
        super("ActiveMQ", "Connector", "ActiveMQBrokerConnectorNotRunning", "A activemq connector is down, not up, disabled or unknown");
    }
}
