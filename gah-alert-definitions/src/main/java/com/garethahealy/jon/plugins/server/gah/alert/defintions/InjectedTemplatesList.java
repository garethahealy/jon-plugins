...
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQBrokerClientConnectorNotRunningTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQBrokerConnectorNotRunningTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQBrokerNetworkConnectorNotRunningTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQBrokerNotRunningTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQBrokerTotalMessagesHighTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQQueueConsumerCountChangedTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQQueueDeenqueueHighTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQQueueEnqueueHighTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQQueueSizeHighTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQTopicConsumerCountChangedTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQTopicDeenqueueHighTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQTopicEnqueueHighTemplate;
import com.garethahealy.jon.plugins.server.gah.alert.defintions.templates.activemq.ActiveMQTopicSizeHighTemplate;
