...
public class FileSystemNotRunningTemplate extends NotRunningTemplate {

    public FileSystemNotRunningTemplate() {
        super("Platforms", "File System", "FileSystemNotRunning", "A file system is down, not up, disabled or unknown");
    }
}
