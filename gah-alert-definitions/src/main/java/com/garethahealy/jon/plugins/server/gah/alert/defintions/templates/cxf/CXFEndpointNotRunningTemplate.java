...
public class CXFEndpointNotRunningTemplate extends NotRunningTemplate {

    public CXFEndpointNotRunningTemplate() {
        super("CXF", "CXF Endpoint", "CXFEndpointNotRunning", "A cxf endpoint is down, not up, disabled or unknown");
    }
}
