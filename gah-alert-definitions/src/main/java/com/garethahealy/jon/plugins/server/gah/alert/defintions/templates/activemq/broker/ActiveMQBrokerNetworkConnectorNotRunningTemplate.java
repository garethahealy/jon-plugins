...
public class ActiveMQBrokerNetworkConnectorNotRunningTemplate extends NotRunningTemplate {

    public ActiveMQBrokerNetworkConnectorNotRunningTemplate() {
        super("ActiveMQ", "Network Connector", "ActiveMQBrokerNetworkConnectorNotRunning", "A activemq network connector is down, not up, disabled or unknown");
    }
}
