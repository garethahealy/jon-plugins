...
public class CXFBusNotRunningTemplate extends NotRunningTemplate {

    public CXFBusNotRunningTemplate() {
        super("CXF", "Bus", "CXFBusNotRunning", "A cxf bus is down, not up, disabled or unknown");
    }
}
