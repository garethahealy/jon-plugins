...
public class ActiveMQBrokerNotRunningTemplate extends NotRunningTemplate {

    public ActiveMQBrokerNotRunningTemplate() {
        super("ActiveMQ", "Broker", "ActiveMQBrokerNotRunning", "A activemq broker is down, not up, disabled or unknown");
    }
}
