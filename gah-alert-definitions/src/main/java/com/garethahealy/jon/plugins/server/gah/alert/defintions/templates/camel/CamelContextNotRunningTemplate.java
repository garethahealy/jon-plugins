...
public class CamelContextNotRunningTemplate extends NotRunningTemplate {

    public CamelContextNotRunningTemplate() {
        super("Camel", "Camel Context", "CamelContextNotRunning", "A camel context is down, not up, disabled or unknown");
    }
}
