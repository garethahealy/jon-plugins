...
public class CamelRouteNotRunningTemplate extends NotRunningTemplate {

    public CamelRouteNotRunningTemplate() {
        super("Camel", "Camel Route", "CamelRouteNotRunning", "A camel route is down, not up, disabled or unknown");
    }
}
