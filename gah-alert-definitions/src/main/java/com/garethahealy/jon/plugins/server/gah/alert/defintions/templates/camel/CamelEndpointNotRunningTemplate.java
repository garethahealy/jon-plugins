...
public class CamelEndpointNotRunningTemplate extends NotRunningTemplate {

    public CamelEndpointNotRunningTemplate() {
        super("Camel", "Camel Endpoint", "CamelEndpointNotRunning", "A camel endpoint is down, not up, disabled or unknown");
    }
}
